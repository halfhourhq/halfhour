...
export const file_table = {
  ...
  fields: {
    connection:
      "DEFINE FIELD connection ON TABLE file TYPE record<connects_with>;",
    ...
    original_filename:
      "DEFINE FIELD original_filename ON TABLE file TYPE string;",
    ...
    updated_at:
      "DEFINE FIELD updated_at ON TABLE file TYPE datetime DEFAULT ALWAYS time::now();",
  },
  indices: {
    unique_b2_file_id:
      "DEFINE INDEX unique_b2_file_id ON TABLE file FIELDS b2_file_id UNIQUE;",
  },
};

export const opened_by_table = {
  table:
    "DEFINE TABLE opened_by SCHEMAFULL TYPE RELATION IN file OUT organiser|attendee;",
  fields: {
    created_at:
      "DEFINE FIELD created_at ON TABLE opened_by TYPE datetime DEFAULT time::now() READONLY;",
  },
  indices: {},
};
